...
import { Ambulance, Bell, ChevronLeft, ChevronRight, CircleHelp, Heart, Info, Mic, Moon, Shield, Smartphone, Sun, User, Wind } from 'lucide-react-native';
...
export default function SettingsScreen() {
    ...
    const { themeMode, setThemeMode, isDarkMode, isAmbulanceMode, setAmbulanceMode, isWomensMode, setWomensMode, isAsthmaMode, setAsthmaMode, isSirenMode, setSirenMode } = useTheme();
